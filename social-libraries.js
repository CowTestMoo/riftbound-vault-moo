(() => {
  ...
  function animateEntry(){const overlay=document.createElement('div');overlay.className='library-transition cosmic';overlay.innerHTML='<div class="cosmic-gate"><i></i><span>ENTERING LIBRARY</span><b>✦</b></div>';document.body.appendChild(overlay);requestAnimationFrame(()=>overlay.classList.add('go'));setTimeout(()=>overlay.remove(),1450)}
